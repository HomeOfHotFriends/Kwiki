...
- Shared motifs: data, design, determinism, oriented, parts
#### [Te Whariki Pumotu](Te-Whariki-Pumotu.md)
- Connection strength: 12
- Shared motifs: data, design, oriented, pumotu, set
#### [Enemy Wave](Enemy-Wave.md)
...
#### [Scripts](Scripts.md)
- Connection strength: 8
- Shared motifs: data, design, oriented, set, zero
#### [Determinism](Determinism.md)
- Connection strength: 7
- Shared motifs: data, design, determinism, oriented
